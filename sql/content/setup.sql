...
INSERT INTO `content` (`path`, `slug`, `type`, `title`, `data`, `filter`, `published`) VALUES
    ...
    ("blogpost-3", "nu-har-hosten-kommit", "post", "Nu har hösten kommit", "Detta är en bloggpost som berättar att sommaren har kommit, ett budskap som kräver en bloggpost", "nl2br", NULL),
    ("", "blocksak", "block", "Blocksak", "Detta är ett block eller nåt. Hejdå.", "", NULL);
